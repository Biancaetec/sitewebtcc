...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    $sql = 'SELECT id_usuario, usu_nome, usu_email, usu_senha FROM usuario WHERE usu_email=:email 
    and usu_senha=:senha';
    ...
    // Verifica se o nome e a senha estão corretos
        ...
        $_SESSION["id"] = $usuario->id_usuario; // Armazena o nome do usuário
        // Redireciona para index.php
        header("Location: indexgestao.php");
        exit();
...
<body>
    ...
    <div class="container mt-5 content">
        ...
        <div class="subtitulo">
        <text > Leve a organização do seu restaurante para outro nível! </text>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/js/bootstrap.bundle.min.js" integrity="sha384-bc6xXc3xFhmlYdDZmV4QbGz4KzgS0A0T5/6Pz6y9jR" crossorigin="anonymous"></script>
</body>
